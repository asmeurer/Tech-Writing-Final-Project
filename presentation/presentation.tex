...
\begin{frame}
    \begin{figure}
    \subfigure{\includegraphics[width=1in]{./python-logo-master-v3-TM.png}}
    \subfigure{\includegraphics[width=1in]{./sympy-160px.png}}
   \subfigure{\includegraphics[width=1in]{./GSoC_2010_logo/2010_NoURL_950x846px.png}}
   \end{figure}
